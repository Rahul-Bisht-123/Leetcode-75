...
is equal to the sum of all the numbers strictly to 
the index's right.
...
'''
# ----------sol--------
# pivot index is,the index whose left items sum == its right items sum
# left sum for leftmost item = 0
# right sum for rightmost item = 0

# we can do this by using the total sum of array
# if we know the total sum , we can calculate the right sum 
# rightsum at index i = totalsum - cur_item - left_sum
# 
