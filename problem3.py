...
where each candies[i] represents the number of candies 
the ith kid has, and an integer extraCandies, denoting the 
...
kid all the extraCandies, they will have the 
...
# add candy[i]+extracandy and check if its >= maxcandy kid
# if its greater add true in ans list, else add false

def KidsWithCandies(candies,extracandy):
